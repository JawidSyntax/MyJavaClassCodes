...
public abstract class Insurance {
	...
	/*Create a class Insurance that will have an attribute as insurance
	 * Name and unimplemented behaviour as getQuote and cancelInsurance.
	 ...
	 *  as carModel and Class Pet has petType attribute.
		Create 3 objects of the sub classes and store them in ArrayList.
 		Using for loop  / advanced for loop/ iterator access methods from different classes.   */ 
